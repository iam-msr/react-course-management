  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="container mx-auto p-6 md:p-8 lg:p-10">
        <div className="bg-white p-6 rounded-lg shadow-md mb-6 flex flex-col lg:flex-row">
          <img 
            src={course.thumbnail} 
            alt={course.name} 
            className="w-full h-48 object-contain rounded-md mb-4 lg:mb-0 lg:w-1/3 lg:mr-6"
          />
          <div className="flex flex-col justify-between lg:w-2/3">
            ...
            <p className="text-gray-700 mb-2"><strong>Enrollment Status:</strong> 
              <span className={`px-3 py-1 rounded-md ${getEnrollmentStatusClass(course.enrollmentStatus)}`}>
